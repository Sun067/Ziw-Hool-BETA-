...
local GET_KEY_URL = "https://discord.gg/mKTAcCqQ4y" -- ใส่ลิ้งก์รับคีย์ของพี่ที่นี่
...
-- [2] Key System UI (เพิ่มปุ่ม Get Key)
...
local function ShowKeySystem(onSuccess)
    ...
    MainFrame.Size = UDim2.new(0, 350, 0, 230) -- เพิ่มความสูงเพื่อรองรับปุ่ม Get Key
    ...
    GetKeyBtn.MouseButton1Click:Connect(function()
        ...
        setclipboard(GET_KEY_URL) -- คัดลอกลิ้งก์
...
local function StartMainScript()
    ...
    -- [5] CACTUS SYSTEM (ห้ามแก้เด็ดขาด)
    ...
    -- [9] TAB: SETTINGS (Anti-AFK & Anti-Ban)
    ...
    InterfaceManager:SetFolder("ZiwHool_GetKey_V34")

    SaveManager:SetFolder("ZiwHool_GetKey_V34/Configs")
